...
const int fistPowerPin = 43;  //First led for power indication
const int secondPowerPin = 44;  //Second led for power indication
const int thirdPowerPin = 45; //Third led for power indication
const int fourthPowerPin = 46;  //Fourth led for power indication
const int fifthPowerPin = 47; //Fifth led for power indication
const int sixthPowerPin = 48; //Sixth led for power indication
const int seventhPowerPin = 49; //Seventh led for power indication
const int eightPowerPin = 50; //Eight led for power indication
const int ninthPowerPin = 51; //Ninth led for power indication
